...
public class WorkThread  implements Runnable{
    ...
    private ServiceProvider severProvider;
    private Socket socket;

    public WorkThread(ServiceProvider severProvider, Socket socket) {
    ...
    public void run() {
        try {
            ...
            // 反射调用对应方法
            Object o = severProvider.getService(request.getInterfaceName());
